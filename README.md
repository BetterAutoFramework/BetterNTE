...
> [!Caution]
>
> 请从官方 [Releases](https://github.com/BetterAutoFramework/BetterNTE/releases) 页面下载软件。通过非官方途径获取的软件可能**含有病毒**，并且一般不是最新的版本，请注意甄别。
...
前往 [Releases](https://github.com/BetterAutoFramework/BetterNTE/releases) 页面下载最新版本。
